...
Chez la plupart d'entre nous, les grands muscles dorsaux sont très contractés; bloquant les micromouvements, et laissant les petits muscles inutilisés, endormis.  
...
Sinon les systèmes musculaires et ligamentaires se substituent à l’os; compensent et souffrent de gaspillage énergétique ou d'autres déviations -aux résultats douloureux-  

![image](https://user-images.githubusercontent.com/12049360/105741050-2812e180-5f3a-11eb-9a33-510f78db6218.png)
 
L'action **dynamique** bénéfique du Tabouret provient de la planchette d’assise mobile; elle provoque en permanence une forme subtile de déstabilisation qui va titiller le réflexe d'auto grandissement, l'ossature se réaligne et les grands muscles se reposent.   
Petit à petit, une musculature très spécifique entre chaque vertèbre peut alors se remettre à fonctionner, l'axe de vie se réveiller et la connexion subtile se restaurer.  

![image](https://user-images.githubusercontent.com/12049360/112754122-03d78d80-8fdb-11eb-955b-f73c214d5f8a.png)

---

## modèles et tarifs
Le tabouret est proposé en 2 versions.  

Développé et produit au fablab Openfab, à Ixelles (BXL).   
Les matériaux sont sélectionnés pour leur valeur écologique;  
_(Mp sapin et bambou = ça pousse vite, 12mm = moins de matière, Roulement inox = durable, cire durcissante OSMO = résistance et écologie)_
...
![image](https://user-images.githubusercontent.com/12049360/112754238-73e61380-8fdb-11eb-93fc-8660bf4e98a1.png)
...
1. Je dépose mon bassin, un de mes aspects TERRE; en alignant mes ischions au dessus de l'axe de rotation de la planchette.  
2. Je me concentre sur le centre de la Terre et, “me laisse aller”; de tout mon poids vers ce centre. Le tabouret, en réponse, renvoie une contre poussée vers le haut qui passe par la colonne.
...
![image](https://user-images.githubusercontent.com/12049360/112754069-beb35b80-8fda-11eb-8381-d1c2b24dd821.png)


>_**[Ostéopathie](https://fr.wikipedia.org/wiki/Ost%C3%A9opathie)**_  
>_...se base sur l'idée selon laquelle toute altération de la mobilité naturelle des organes les uns par rapport aux autres, apparaissant au niveau des muscles, des tendons, des viscères, du crâne ou des enveloppes (fasciae), induirait des dysfonctionnements_
...
La sensation est compacte et peut être rassurante du point de vue de la densité, mais à comme résultat la fermeture et le blocage.   
_On parle parfois de “cuirasse musculaire”, cela vous donne la définition sensorielle._
...
_Il faut se libérer de cette cuirasse._  
...
> Une image suplémentaire pour comprendre l'importance de l'action des muscles courts intervertébraux.  
Ils agissent comme le font les pinces à linges, vous presser d’un côté, celà ouvre de l’autre. Il s’ensuit un dégagement des fameux [TROUS DE CONJUGAISONS](https://fr.wikipedia.org/wiki/Foramen_intervert%C3%A9bral).  
...
## Energie subtile et chakras

![image](https://user-images.githubusercontent.com/12049360/112753423-e5bc5e00-8fd7-11eb-9df9-c7498e65e2d4.png)

Les courants électriques multiples et variés, descendants du Ciel et remontant de la Terre, ont besoin d’un libre passage pour pouvoir ensemencer nos 7 principaux chakras.  
La colonne alignée, c’est à dire la structure osseuse accomplissant son rôle, le système électrique musculaire de très haut voltage`*` se débranche et libère le circuit, enfin disponible pour recevoir les fréquences plus subtiles.  
`* souvenez-vous de crise épileptique pour vous faire une idée.`
...
La position recommandée sur ce tabouret vivant est celle pratiquée par les japonais:  
Assis les chevilles allongées, genoux, cuisses strictement parallèles.   
...
- Action rééquilibrante sur les **méridiens Estomac - Rate Pancréas** par le fait de les paralléliser au niveau des membres inférieurs, face antérieur.  
Ces 2 méridiens se trouvent en connexion directe avec la résonance TERRE GAÏA, et plus subtilement, aide à la reconnexion avec le sentiment de PAIX et de sécurité (rate Pancréas). La féminité aussi.   
> Et pour la grande majorité d’entre nous, ils en voient de toutes les couleurs, avec pour conséquence toutes sortes de problèmes de GENOUX - déviation VARUM-VALGUM - instabilité TALON - déséquilibre ABDUCTEUR ADDUCTEUR - USURE CARTILAGE - MÉNISQUE etc...  

- Sur la face postérieure, on retrouve les **méridiens Vessie-Reins** que l’on ralentit d'une part, en dessous du bassin - que l’on augmente d'autre part, au-dessus jusqu’à la tête. Renforcement des Reins pour “garder le cap”.
